 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-referencie")) new core(".slider-referencie", {
                ...
                navigation: {
                    prevEl: ".slider-referencie__arrow_prev",
                    nextEl: ".slider-referencie__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
        ...
        window.addEventListener("load", (function(e) {
            intl_tel_input(input, {
                ...
                geoIpLookup: function(callback) {
                    fetch("https://ipinfo.io/json").then((response => response.json())).then((data => callback(data && data.country ? data.country : "us")));
                },
        ...
        if (menuItems.length) {
            ...
            menuItems.forEach((item => {
                item.style.setProperty("--delay", `${delay += .3}s`);
            }));
        }
        if (window.screen.width >= 992) {
            ...
            function menuEffect() {
                ...
                function menuEffectItem(menuLinks, effectSpeed) {
                    ...
                    const effectTop = `transform: translate3d(-150%, 0px, 0px);`;
                    const effectBottom = `transform: translate3d(150%, 0px, 0px);`;
                    menuLinks.forEach((menuLink => {
                        menuLink.insertAdjacentHTML("beforeend", `\n\t\t\t\t<span style="transform: translate3d(150%,0px,0px);" class="hover">\n\t\t\t\t\t<span style="transform: translate3d(-150%,0px,0px);" class="hover__text">${menuLink.textContent}</span>\n\t\t\t\t</span>\n\t\t\t`);
